# Code explanation
## Introduction
In this section, we will explain how we coded QAOA using Qiskit's library. There is the simple way of using Qiskit's built-in functions, or a more advanced way of constructing your own Hamiltonian and QAOA.
...
6. `show_path`
  - input: filtered dictionary of result, cost_matrix
  - output: print optimal path and return the cost of the path
